...
- #### Husky, Prettier, Lint, and Commitlint Configured
    ...
    2. commit-msg, running commitlint to ensure the use of [Conventional Commit](https://heri.life/library/conventional-commit-readme) for commit messages
...
- #### Default Tailwind CSS Base Styles
    ...
    There are default styles for responsive heading sizes, and `.layout` to support a max-width for larger screen size. Find more about it on [my blog post](https://heri.life/blog/tailwindcss-best-practice#1-using-layout-class-or-container)
...
1. Seo component
2. Layout class to give constraint to viewport width. [Read more about layout class](https://heri.life/blog/tailwindcss-best-practice#1-using-layout-class-or-container).
