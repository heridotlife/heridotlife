...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  // Astro v6 removed direct access to Astro.locals.runtime.env.
  // Normalize runtime bindings in locals so existing route/page code can keep using context.locals.runtime.env.
  try {
