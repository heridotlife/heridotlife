          ...
          <ol className='mt-8 space-y-6'>
            ...
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnstyledLink href='https://heri.life'>
                  Outside Links
                </UnstyledLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <PrimaryLink href='https://heri.life'>
                  Outside Links
                </PrimaryLink>
              </div>
            </li>
            <li className='space-y-2'>
              ...
              <div className='space-x-2'>
                ...
                <UnderlineLink href='https://heri.life'>
                  Outside Links
                </UnderlineLink>
              </div>
            </li>
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <ButtonLink variant='primary' href='https://heri.life'>
                  Primary Variant
                </ButtonLink>
                <ButtonLink
                  variant='outline'
                ...
                <ButtonLink variant='dark' href='https://heri.life'>
                  Dark Variant
                </ButtonLink>
                <ButtonLink variant='light' href='https://heri.life'>
                  Light Variant
                </ButtonLink>
              </div>
            </li>
